...
/// <summary>
///   Shape checks for the two identifiers the admin surfaces store without creating an account
...
public static class AdminIdentifiers
{
	...
	public static string? LoginProblem(string? login)
	{
	...
	public static string? HrefProblem(string? href)
	{
