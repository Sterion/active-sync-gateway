...
namespace ActiveSync.Core.Migrations.Sqlite
{
    ...
    public partial class NormalizeAccountUserNameCasing : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // pre-fix case-variant pair (e.g. `Phone1` + `phone1`) that both fit under the BINARY index.
            ...
            // Case-fold the survivors so index and lookup agree. (SQLite lower() folds ASCII only, which
            // matches the dominant login shapes; non-ASCII logins are handled by NormalizeLogin on the
            // next write.)
            migrationBuilder.Sql(
                """
