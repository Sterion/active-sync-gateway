...
public sealed class CliLocalEndpointTests : IDisposable
{
	...
	// single-use enforcement lives exclusively in ReplayCache (see ReplayCacheTests below /
	// CliLocalEndpointTests' replay-focused cases) rather than in two places with different
	// safety properties.
