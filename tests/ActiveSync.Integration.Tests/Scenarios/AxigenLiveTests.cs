...
public sealed class AxigenGatewayFixture : IAsyncLifetime
{
	...
	private WebApplicationFactory<Program> CreateFactory()
	{
		Dictionary<string, string?> settings = new()
		{
			...
			["ActiveSync:Backends:MailStore:Host"] = AxigenBackend.Host,
			["ActiveSync:Backends:MailStore:Port"] = "993",
			["ActiveSync:Backends:MailStore:UseSsl"] = "true",
			["ActiveSync:Backends:MailSubmit:Provider"] = "smtp",
			["ActiveSync:Backends:MailSubmit:Host"] = AxigenBackend.Host,
			["ActiveSync:Backends:MailSubmit:Port"] = "465",
			["ActiveSync:Backends:MailSubmit:UseSsl"] = "true",
			["ActiveSync:Backends:Calendar:Provider"] = "caldav",
			["ActiveSync:Backends:Calendar:BaseUrl"] = $"http://{AxigenBackend.Host}",
			["ActiveSync:Backends:Calendar:HomeSetPath"] = "/Calendar/",
			["ActiveSync:Backends:Tasks:Provider"] = "caldav",
			["ActiveSync:Backends:Contacts:Provider"] = "carddav",
			["ActiveSync:Backends:Contacts:BaseUrl"] = $"http://{AxigenBackend.Host}",
			["ActiveSync:Backends:Contacts:HomeSetPath"] = "/Contacts/",
